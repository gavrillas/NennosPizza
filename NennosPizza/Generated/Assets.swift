...
internal enum Asset {
  internal enum Color {
    ...
    internal static let seperatorColor = ColorAsset(name: "SeperatorColor")
    internal static let textColor = ColorAsset(name: "TextColor")
  }
  internal enum Image {
    internal static let accentColor = ColorAsset(name: "AccentColor")
    internal static let background = ImageAsset(name: "Background")
    internal static let cartButton = ImageAsset(name: "CartButton")
    internal static let cartNavbar = ImageAsset(name: "CartNavbar")
